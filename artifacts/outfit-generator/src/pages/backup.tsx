...
const ROSE      = "#F4D6DD";   // dusty pink — Spin It button colour
const ROSE_DARK = "#D9A7B3";   // dusty pink mid
...
function RoseButton({
  ...
  return (
    <button
      ...
      style={{
        background: disabled ? '#D9A7B3' : 'linear-gradient(to bottom, #F4D6DD, #D9A7B3)',
