...
const ROSE      = "#F4A7BA";   // dusty pink — Spin It button colour
const ROSE_DARK = "#E8899F";   // dusty pink mid
...
function RoseButton({
  ...
  return (
    <button
      ...
      style={{
        background: disabled ? '#E8899F' : 'linear-gradient(to bottom, #F4A7BA, #E8899F)',
