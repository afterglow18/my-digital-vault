...
export default function AccountPage() {
    ...
    try {
      ...
      setErrorMsg(
        err instanceof Error && err.message.includes('Invalid')
          ? "This file doesn't look like a valid filing cabinet backup."
  ...
  return (
    ...
    >
      {/* Page title */}
      <div className="px-5 pt-8 pb-5 md:max-w-2xl md:mx-auto">
        <h1
      ...
      <div className="px-5 flex flex-col gap-4 md:max-w-2xl md:mx-auto">
        ...
        <Card>
          <div className="px-4 pt-4 pb-5 flex flex-col gap-3">
            ...
            <p className="text-sm text-black/60 leading-snug">
              Export your filing cabinet to a JSON file. Save it to iCloud Drive or Files to keep
            ...
            <p className="text-xs font-bold leading-snug" style={{ color: '#C0392B' }}>
              ⚠️ Deleting the app removes all your filing cabinet data.
            ...
            <p className="text-xs text-black/40 text-center leading-snug">
              Importing replaces your current filing cabinet with the backup.
            </p>
        ...
        <Card>
          <div className="px-4 pt-4 pb-5 flex flex-col gap-2">
            <div className="flex items-center gap-2">
              <span className="text-2xl leading-none">🔐</span>
              <h2 className="font-black text-base uppercase tracking-wide">My Digital Filing Cabinet</h2>
            </div>
            <p className="text-sm text-black/50 font-medium">Version {APP_VERSION}</p>
            <p className="text-sm text-black/60 leading-snug">
              Your filing cabinet stays on your device, works offline, and can be backed up with iCloud.
            </p>
          </div>
        </Card>
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-black/60 mb-5 leading-snug">
                This will permanently delete your current filing cabinet and replace it with the backup.
